...
void main(){gl_Position=position;}`;
  ...
  const resize = () => {
    ...
    canvas.height = Math.max(window.innerHeight * 0.9, 820) * dpr;
...
export default function AnimatedShaderHero({
  ...
  return (
    <section className={`relative min-h-screen w-full overflow-hidden bg-black ${className}`}>
      ...
      <div className="relative z-10 mx-auto flex min-h-screen w-full max-w-7xl flex-col items-center px-6 pb-16 pt-28 text-white">
        {trustBadge ? (
