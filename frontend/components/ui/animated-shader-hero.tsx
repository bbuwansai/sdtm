  ...
  return (
    <section className={`relative isolate overflow-hidden border-b border-white/6 bg-[#090705] ${className}`}>
      ...
      <div className="absolute inset-0 opacity-70">
        ...
        <div className="absolute left-[-4%] top-[43%] h-px w-[108%] bg-gradient-to-r from-transparent via-[#ffd7a6] to-transparent opacity-95 shadow-[0_0_22px_rgba(255,215,166,0.9)]" />
        <div className="absolute left-[-6%] top-[52%] h-px w-[112%] bg-gradient-to-r from-transparent via-[#fff1dc] to-transparent opacity-80 shadow-[0_0_18px_rgba(255,241,220,0.7)]" />
        <div className="absolute right-[-10%] top-[8%] h-[26rem] w-[38rem] rounded-full border border-[#e2b47d]/10 bg-[radial-gradient(circle,rgba(136,90,52,0.25)_0%,transparent_62%)] blur-2xl" />
      </div>
